...
main(int argc, char **argv)
{
	...
	src_buffer = (char *)malloc(dma_conf.buffer_size);
	if (src_buffer == NULL) {
	...
	result = dma_copy_host(&pcie_dev, src_buffer, dma_conf.buffer_size, dma_conf.export_desc_path, dma_conf.buf_info_path);
	if (result != DOCA_SUCCESS) {
